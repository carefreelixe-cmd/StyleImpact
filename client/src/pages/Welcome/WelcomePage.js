      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Showcase Your Creative Talent for the Modern World
          </h1>
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Join India's premier creative competition platform — crafted for artists, designed for recognition.
          </p>
          <button className="bg-primary hover:bg-hoverPrimary text-black font-semibold px-8 py-3 rounded-lg transition-all duration-300 transform hover:scale-105">
            Start Competing Now
          </button>
        </div>
      </div>
